...
<html lang="en-us"><head>
  ...
  <!-- plugins -->
  <link rel="stylesheet" href="{{asset('asset/website/plugins/bootstrap/bootstrap.min.css')}}">
  <link rel="stylesheet" href="{{asset('asset/website/plugins/themify-icons/themify-icons.css')}}">
  <link rel="stylesheet" href="{{asset('asset/website/plugins/slick/slick.css')}}">

  <!-- Main Stylesheet -->
  <link rel="stylesheet" href="{{asset('asset/website/css/style.css')}}" media="screen">
  ...
  <div class="container">
    <nav class="navbar navbar-expand-lg navbar-white">
      <a class="navbar-brand order-1" href="{{route('index')}}">
        <img class="img-fluid" width="100px" src="{{asset('asset/website/images/logo.png')}}"
      ...
      <div class="order-2 order-lg-3 d-flex align-items-center">
        <select class="m-2 border-0 bg-transparent" id="select-language">
          <option id="en" value="" selected>User</option>
          <option id="fr" value="">Admin</option>
        </select>
...
<footer class="footer">
    ...
    <!-- JS Plugins -->
    <script src="{{asset('asset/website/plugins/jQuery/jquery.min.js')}}"></script>
  
    <script src="{{asset('asset/website/plugins/bootstrap/bootstrap.min.js')}}"></script>
  
    <script src="{{asset('asset/website/plugins/slick/slick.min.js')}}"></script>
  
    <script src="{{asset('asset/website/plugins/instafeed/instafeed.min.js')}}"></script>
  
  
    <!-- Main Script -->
    <script src="{{asset('asset/website/js/script.js')}}"></script></body>
  </html>